...
class HomeThingsPage extends StatefulWidget {
  const HomeThingsPage({Key? key}) : super(key: key);

  @override
  State<HomeThingsPage> createState() => _HomeThingsPageState();
}

class _HomeThingsPageState extends State<HomeThingsPage> {
  @override
                                      ...
                                      child: Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              setState(() {
                                                home[i].isLiked = !home[i].isLiked;
                                              });
                                              if (home[i].isLiked == true) {
                                                Provider.of<LikeController>(context, listen: false).addProduct(product: home[i]);
                                              } else if (home[i].isLiked == false) {
                                                Provider.of<LikeController>(context, listen: false).removeProduct(product: home[i]);
                                              }
                                            },
                                            child: (home[i].isLiked == false)
                                                ? const Icon(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Text(
                                          "Rs. ${home[i].discountPrice.toString()}",
                                          style: GoogleFonts.arya(
                                            fontWeight: FontWeight.w600,
                                    ...
                                    Align(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () async {
                                          Provider.of<CartController>(context, listen: false).addProduct(product: home[i]);
                                          Get.showSnackbar(
                                            GetSnackBar(
                                              title: 'Cart',
