                                      ...
                                      child: Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              setState(() {
                                                furniture[i].isLiked = !furniture[i].isLiked;
                                              });
                                              if (furniture[i].isLiked == true) {
                                                Provider.of<LikeController>(context, listen: false).addProduct(product: furniture[i]);
                                              } else if (furniture[i].isLiked == false) {
                                                Provider.of<LikeController>(context, listen: false).removeProduct(product: furniture[i]);
                                              }
                                            },
                                            child: (furniture[i].isLiked == false)
                                                ? const Icon(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Text(
                                          "Rs. ${furniture[i].discountPrice.toString()}",
                                          style: GoogleFonts.arya(
                                            fontWeight: FontWeight.w600,
                                        ...
                                        Text(
                                          "Rs. ${furniture[i].dummyPrice.toString()}",
                                          style: GoogleFonts.arya(
                                            fontWeight: FontWeight.w600,
                                            fontSize: 14,
                                          ),
                                    ...
                                    Align(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () async {
                                          Provider.of<CartController>(context, listen: false).addProduct(product: furniture[i]);
                                          Get.showSnackbar(
                                            GetSnackBar(
                                              title: 'Cart',
                                              ...
                                              message:
                                              '${furniture[i].name} Added to cart...',
