                                      ...
                                      child: Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              setState(() {
                                                beauty[i].isLiked = !beauty[i].isLiked;
                                              });
                                              if (beauty[i].isLiked == true) {
                                                Provider.of<LikeController>(context, listen: false).addProduct(product: beauty[i]);
                                              } else if (beauty[i].isLiked == false) {
                                                Provider.of<LikeController>(context, listen: false).removeProduct(product: beauty[i]);
                                              }
                                            },
                                            child: (beauty[i].isLiked == false)
                                                ? const Icon(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Text(
                                          "Rs. ${beauty[i].discountPrice.toString()}",
                                          style: GoogleFonts.arya(
                                            fontWeight: FontWeight.w600,
                                        ...
                                        Text(
                                          "Rs. ${beauty[i].dummyPrice.toString()}",
                                          style: GoogleFonts.arya(
                                            fontWeight: FontWeight.w600,
                                            fontSize: 14,
                                          ),
                                    ...
                                    Align(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () async {
                                          Provider.of<CartController>(context, listen: false).addProduct(product: beauty[i]);
                                          Get.showSnackbar(
                                            GetSnackBar(
                                              title: 'Cart',
