                                      ...
                                      child: Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              setState(() {
                                                fashion[i].isLiked = !fashion[i].isLiked;
                                              });
                                              if (fashion[i].isLiked == true) {
                                                Provider.of<LikeController>(context, listen: false).addProduct(product: fashion[i]);
                                              } else if (fashion[i].isLiked == false) {
                                                Provider.of<LikeController>(context, listen: false).removeProduct(product: fashion[i]);
                                              }
                                            },
                                            child: (fashion[i].isLiked == false)
                                                ? const Icon(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Text(
                                          "Rs. ${fashion[i].discountPrice.toString()}",
                                          style: GoogleFonts.arya(
                                            fontWeight: FontWeight.w600,
                                        ...
                                        Text(
                                          "Rs. ${fashion[i].dummyPrice.toString()}",
                                          style: GoogleFonts.arya(
                                            fontWeight: FontWeight.w600,
                                            fontSize: 14,
                                          ),
                                    ...
                                    Align(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () async {
                                          Provider.of<CartController>(context, listen: false).addProduct(product: fashion[i]);
                                          Get.showSnackbar(
                                            GetSnackBar(
                                              title: 'Cart',
