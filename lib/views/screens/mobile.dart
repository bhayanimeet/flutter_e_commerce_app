                                      ...
                                      child: Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              setState(() {
                                                mobile[i].isLiked = !mobile[i].isLiked;
                                              });
                                              if (mobile[i].isLiked == true) {
                                                Provider.of<LikeController>(context, listen: false).addProduct(product: mobile[i]);
                                              } else if (mobile[i].isLiked == false) {
                                                Provider.of<LikeController>(context, listen: false).removeProduct(product: mobile[i]);
                                              }
                                            },
                                            child: (mobile[i].isLiked == false)
                                                ? const Icon(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Text(
                                          "Rs. ${mobile[i].discountPrice.toString()}",
                                          style: GoogleFonts.arya(
                                            fontWeight: FontWeight.w600,
                                        ...
                                        Text(
                                          "Rs. ${mobile[i].dummyPrice.toString()}",
                                          style: GoogleFonts.arya(
                                            fontWeight: FontWeight.w600,
                                            fontSize: 14,
                                          ),
                                    ...
                                    Align(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () async {
                                          Provider.of<CartController>(context, listen: false).addProduct(product: mobile[i]);
                                          Get.showSnackbar(
                                            GetSnackBar(
                                              title: 'Cart',
