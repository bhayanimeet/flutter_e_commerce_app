                                      ...
                                      child: Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              setState(() {
                                                grocery[i].isLiked = !grocery[i].isLiked;
                                              });
                                              if (grocery[i].isLiked == true) {
                                                Provider.of<LikeController>(context, listen: false).addProduct(product: grocery[i]);
                                              } else if (grocery[i].isLiked == false) {
                                                Provider.of<LikeController>(context, listen: false).removeProduct(product: grocery[i]);
                                              }
                                            },
                                            child: (grocery[i].isLiked == false)
                                                ? const Icon(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Text(
                                          "Rs. ${grocery[i].discountPrice.toString()}",
                                          style: GoogleFonts.arya(
                                            fontWeight: FontWeight.w600,
                                        ...
                                        Text(
                                          "Rs. ${grocery[i].dummyPrice.toString()}",
                                          style: GoogleFonts.arya(
                                            fontWeight: FontWeight.w600,
                                            fontSize: 14,
                                          ),
                                    ...
                                    Align(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () async {
                                          Provider.of<CartController>(context, listen: false).addProduct(product: grocery[i]);
                                          Get.showSnackbar(
                                            GetSnackBar(
                                              title: 'Cart',
